...
class StatsTest(TestCase):
    ...
    def test_response_break_up(self):
        ...
        self.assertEquals(break_up[0].percentage, 14.9)
        self.assertEquals(break_up[1].percentage, 55.3)
        self.assertEquals(break_up[2].percentage, 23.4)
        self.assertEquals(break_up[3].percentage, 6.4)
    ...
    def test_most_voted_category_in_loc(self):
        ...
        category = governorate.most_popular_category(question)
